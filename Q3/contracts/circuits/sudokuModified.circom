...
template sudoku() {
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            rangeProofPuzzle[i][j].range[0] <== 9;
            rangeProofPuzzle[i][j].range[1] <== 0;

            rangeProofSolution[i][j].in <== solution[i][j];
            rangeProofSolution[i][j].range[0] <== 9;
            rangeProofSolution[i][j].range[1] <== 0;

            rangeProofPuzzle[i][j].out * rangeProofSolution[i][j].out === 1; 
